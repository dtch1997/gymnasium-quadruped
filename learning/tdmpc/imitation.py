...
from cdrl import experiments
from learning.tdmpc import tdmpc
from learning.tdmpc.rot import rewarder_v2
from cdrl.imitation import imitation_experiment
from cdrl.utils import experiment_utils
...
def make_experiment_config(config):
    ...
    def rewarder_factory(variable_source, spec):
        ...
        if rewarder_config.use_encoder:
            preprocessor = rewarder_v2.MeanStdPreprocessor(
            ...
            preprocessor = rewarder_v2.EncoderPreprocessor(
        ...
        rewarder = rewarder_v2.ROTRewarder(
