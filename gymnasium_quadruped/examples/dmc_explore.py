...
flags.DEFINE_bool(
    "visualize_reward", True, "Whether to vary the colors of geoms according to the current reward value."
)
flags.DEFINE_float(
    "action_noise",
    0.0,
...
def main(argv):
    ...
    if environment_name is None:
        ...
        environment_name = prompt_environment_name("Please select an environment name: ", _ALL_NAMES)
